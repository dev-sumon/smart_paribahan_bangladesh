...
@section('title', 'Stand Notice Edit')
@section('content')
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-10 m-auto">
                                <form action="{{ route('stand_manager.notice.stand.manager.update', $notice->id) }}"
                                        ...
                                        <select name="division_id" id="division" class="form-control">
                                            ...
                                            @foreach ($divisions as $division)
                                                <option value="{{ $division->id }}"
                                                    {{ $notice->division_id == $division->id ? 'selected' : '' }}>
                                                    {{ $division->division }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select name="district_id" id="district" class="form-control">
                                            ...
                                            @foreach ($districts as $district)
                                                <option value="{{ $district->id }}"
                                                    {{ $notice->district_id == $district->id ? 'selected' : '' }}>
                                                    {{ $district->district }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select name="thana_id" id="thana" class="form-control">
                                            ...
                                            @foreach ($thanas as $thana)
                                                <option value="{{ $thana->id }}"
                                                    {{ $notice->thana_id == $thana->id ? 'selected' : '' }}>
                                                    {{ $thana->thana }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select name="union_id" id="union" class="form-control">
                                            ...
                                            @foreach ($unions as $union)
                                                <option value="{{ $union->id }}"
                                                    {{ $notice->union_id == $union->id ? 'selected' : '' }}>
                                                    {{ $union->union }}
                                                </option>
                                            @endforeach
                                        </select>
