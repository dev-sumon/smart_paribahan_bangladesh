@extends('field_worker.layouts.master', ['page_slug' => 'owner'])
@section('title', 'Oner Update')
@section('content')
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <span class="float-right">
                            <a href="{{ route('field_worker.owner.index') }}" class="btn btn-info">{{ __('Back') }}</a>
                        </span>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-10 m-auto">
                                <form action="{{ route('field_worker.owner.update', $owner->slug) }}" method="POST"
