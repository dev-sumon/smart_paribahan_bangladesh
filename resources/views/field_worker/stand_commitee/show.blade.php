...
@section('title', 'Stand Commitee Detalis')
@section('content')
                                ...
                                <table class="table table-bordered table-striped dataTable dtr-inline">
                                    <tbody>
                                        ...
                                        {{-- <tr>
                                            ...
                                            <th>{{ __(':') }}</th>
                                            <td>{{ $commitee->vehicle->vehicleType->name }}</td>
                                        </tr> --}}
                                        <tr>
                                            <th>{{ __('Image') }}</th>
                                            <th>{{ __(':') }}</th>
                                            <td><img src="{{ asset('storage/' . $commitee->image) }}"
                                                    alt="{{ $commitee->name }}" width="100"></td>
                                        </tr>
                                        <tr>
                                            <th>{{ __('Status') }}</th>
                                            <th>{{ __(':') }}</th>
                                            <td><span
                                                    class="{{ $commitee->statusBg() }}">{{ $commitee->statusTitle() }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>{{ __('Created At') }}</th>
