                                ...
                                <table class="table table-bordered table-striped dataTable dtr-inline">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th>{{ __(':') }}</th>
                                            <td>{{ $driver->owner ? $driver->owner->vehicles_license : __('Not Assigned') }}
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <th>{{ __('Image') }}</th>
                                            <th>{{ __(':') }}</th>
                                            <td><img src="{{ asset('storage/' . $driver->image) }}"
                                                    alt="{{ $driver->name }}" width="100"></td>
                                        </tr>
                                        <tr>
                                            <th>{{ __('Status') }}</th>
                                            <th>{{ __(':') }}</th>
                                            <td><span
                                                    class="{{ $driver->statusBg() }}">{{ $driver->statusTitle() }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>{{ __('Created At') }}</th>
