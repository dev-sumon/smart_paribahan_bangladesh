                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <span class="float-right">
                            <a href="{{ route('field_worker.driver.index') }}" class="btn btn-info">{{ __('Back') }}</a>
                        </span>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-10 m-auto">
                                <form action="{{ route('field_worker.driver.update', $driver->slug) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title"
                                            placeholder="Enter The Driver Name" name="title"
                                            value="{{ old('title') ?? $driver->title }}" oninput="slugGenerate($(this))">
                                        @if ($errors->has('title'))
                                        ...
                                        <select name="division_id" id="division" class="form-control">
                                            ...
                                            @foreach ($divisions as $division)
                                                <option value="{{ $division->id }}"
                                                    {{ $driver->division_id == $division->id ? 'selected' : '' }}>
                                                    {{ $division->division }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="tel" name="phone"
                                                value="{{ old('phone') ?? $driver->phone }}" class="form-control"
                                        ...
                                        <div class="form-group mt-3">
                                            <label for="image">{{ __('Image') }} <span
                                                    class="text-danger">*</span></label>
                                            @if ($driver->image)
                                                <img src="{{ Storage::url($driver->image) }}" alt="{{ $driver->name }}"
                                                    class="display-image"
                                            ...
                                            <input type="file" class="form-control h-auto" id="image"
                                                placeholder="Enter Driver Image" name="image">
                                            @if ($errors->has('image'))
