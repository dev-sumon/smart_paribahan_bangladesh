                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <span class="float-right">
                            <a href="{{ route('field_worker.yearly_notice.create') }}" class="btn btn-info">{{ __('Create') }}</a>
                        </span>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group" role="group" aria-level="Basic example">
                                                        ...
                                                        <a href="{{ route('field_worker.yearly_notice.update', $yearly_notice->id) }}"
                                                            data-id="" class="btn btn-info"><i
                                                                class="fa-solid fa-pen-to-square"></i></a>
                                                        <a href="javascript:void(0)"
                                                            data-url="{{ route('field_worker.yearly_notice.delete', $yearly_notice->id) }}"
                                                            class="btn btn-danger delete"><i
                                                                class="fa-solid fa-trash-can"></i></a>
                                                        <a href="javascript:void(0)"
                                                            data-url="{{ route('field_worker.yearly_notice.status.update', $yearly_notice->id) }}"
