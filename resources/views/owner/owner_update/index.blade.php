        ...
        <div class="container profile-container">
            <div class="profile-card">
                ...
                <div class="profile-body">
                    <form id="profileForm" action="{{ route('owner.owner_update', $owner->slug) }}" method="POST"
                        ...
                        <div class="profile-image-container">
                            @if ($owner->image)
                                <img src="{{ asset('storage/' . $owner->image) }}" alt="{{ $owner->title }}" height="180"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="title" name="title"
                                            placeholder="নাম" value="{{ old('name') ?? $owner->title }}" oninput="slugGenerate($(this))">
                                    </div>
