...
@section('title', $union_notice->union->union)
@section('content')
     <!-- president and members section start-->
     <section class="president_and_members pt-5 pb-4">
        <div class="container">
            <div class="stand_location">
                <h3>{{ $union_notice->division->division }} - {{ $union_notice->district->district }} - {{ $union_notice->thana->thana }} - {{ $union_notice->union->union }}</h3>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-9">
                    <div class="title pt-2">
                      ...
                      @foreach ($union_notice->notices->take(4) as $key=>$notice)
                    ...
                    <div class="all_notice_button text-end">
                        <a href="{{ route('f.home.districtNotice', $union_notice->id) }}" class="gradient-border-button">
                            <span>{{ __('All') }}</span>
                ...
                <div class="year col-12 col-md-6">
                  <select name="" id="" class="form-select">
                    <option value="">{{ __('Select Date') }}</option>
                      @foreach ($union_notice->notices as $notice)
          ...
          <div class="table-responsive">
            <table class="table table text-center">
              ...
              <tbody>
                ...
                @foreach ($union_notice->notices as $key=>$notice)
                  <tr>
