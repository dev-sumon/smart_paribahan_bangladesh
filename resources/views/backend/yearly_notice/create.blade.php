                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-10 m-auto">
                                <form action="{{ route('yearly_notice.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="stand_id" id="stand" class="form-control">
                                            ...
                                            @foreach ($stands as $stand)
                                                <option value="{{ $stand->id }}" {{ $stand->id==old('stand_id') ? 'selected' : '' }}>{{ $stand->title }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="date" value="{{ old('date') }}" class="form-control" placeholder="Enter The Date">
                                        @if($errors->has('date'))
